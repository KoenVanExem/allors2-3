...
namespace Allors.Database.Domain
{
    ...
    public partial class Countries
    {
        ...
        public Cache<string, Country> CountryByIsoCode => this.countryByIsoCode ??= new Cache<string, Country>(this.Transaction, M.Country.IsoCode);

        protected override void CorePrepare(Setup setup) => setup.AddDependency(this.ObjectType, M.Currency);
