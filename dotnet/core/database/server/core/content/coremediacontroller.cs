...
namespace Allors.Database.Server.Controllers
{
    ...
    public abstract class CoreMediaController : Controller
    {
        protected const int OneYearInSeconds = 60 * 60 * 24 * 356;

        protected CoreMediaController(ITransactionService transactionService) => this.Transaction = transactionService.Transaction;
