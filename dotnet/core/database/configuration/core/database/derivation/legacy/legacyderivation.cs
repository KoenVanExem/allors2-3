...
namespace Allors.Database.Configuration.Derivations.Default
{
    ...
    public class LegacyDerivation : ILegacyDerivation
    {
        ...
        public LegacyDerivation(ITransaction transaction, int maxCycles, bool continueOnError)
        {
        ...
        public void Mark(IEnumerable<Object> objects) => this.MarkedBacklog.UnionWith(objects);
