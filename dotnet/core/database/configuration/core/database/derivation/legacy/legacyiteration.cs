...
namespace Allors.Database.Configuration.Derivations.Default
{
    ...
    public class LegacyIteration : ILegacyIteration
    {
        ...
        public void Mark(IEnumerable<Object> objects)
        {
            foreach (var @object in objects)
            {
                this.Mark(@object);
        ...
        public void Execute(List<Object> postDeriveBacklog, Object[] marked = null)
        {
            try
            {
                var accumulatedChangeSet = new AccumulatedChangeSet();
                var changeSet = this.LegacyCycle.Derivation.Transaction.Checkpoint();
                accumulatedChangeSet.Add(changeSet);
                ...
                this.LegacyPreparation = new LegacyPreparation(this, marked, accumulatedChangeSet);
